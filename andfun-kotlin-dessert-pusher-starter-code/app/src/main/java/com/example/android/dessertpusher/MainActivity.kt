...
private const val KEY_SECONDS_COUNT = "SECONDS_COUNT"
...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onStart() {
        super.onStart()
        Timber.i("onStart Step")
    }

    override fun onResume() {
        super.onResume()
        Timber.i("onResume Step")
    }

    override fun onPause() {
        super.onPause()
        Timber.i("onPause Step")
    }

    override fun onDestroy() {
        super.onDestroy()
        Timber.i("onDestroy Step")
    }

    override fun onRestart() {
        super.onRestart()
        Timber.i("onRestart Step")
    }

    override fun onStop() {
        super.onStop()
        Timber.i("onStop Step")
    }

    override fun onSaveInstanceState(outState: Bundle?) {
        super.onSaveInstanceState(outState)
        Timber.i("onSaveInstanceState Step")
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle?) {
        ...
        Timber.i("onRestoreInstanceState Step")
    }
